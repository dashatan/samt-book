...
export default function Slider(props) {
  ...
  return (
    <Box
      id={props.id} className="swiper-container" style={props.style || {
      height: 200
    }}
    >
            ...
            return (
              ...
              >
                {correctUrl(slide.link) && slide.link
                  ?
                  <a href={correctUrl(slide.link) && slide.link}>
                    <img src={slide.image} alt={slide.title} style={{height: '100%', width: '100%'}}/>
                  </a>
                  :
                  <a href={slide.image} data-fancybox={props.id}>
                    <img src={slide.image} alt={slide.title} style={{height: '100%', width: '100%'}}/>
                  </a>
                }
              </Box>
