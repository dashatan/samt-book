import {AppBar, Button, Fab, Slide, Switch, TextField, Toolbar} from "@material-ui/core";
...
class FilterModal extends React.Component {
  ...
  render() {
    ...
    return (
      <Slide direction={"left"} in={this.state.showFilterModal}>
        <Box className="filter-modal" style={{
          zIndex:10000
        }}>
          <AppBar color="inherit" position="fixed" style={{marginBottom: 10}}>
            <Toolbar
              style={{
                display: "flex",
            ...
            >
              <div>
                <TextField
                  ...
                  autoFocus={this.props.location.state.searchFieldAutoFocus}
                />
              </div>
              <Fab
                size="small"
          ...
          <AppBar
            ...
            color="inherit"
          >
            <Button style={{width: "100%"}} color="secondary" variant="contained" onClick={this.dispatchFilters}>
